const workExperienceTimelineData = [
...

  {
    ...
    position: "Associate",
    data: [
      "Applied economic and financial analysis to complex commercial problems, with a focus on matters related to banking and financial institutions, fintech and new technologies, and valuation.",
      "Led teams supporting academic and industry experts in a variety of cases, including merges and acquisitions and litigation related to bank regulatory actions, ERISA, and securities lending.",
      "Synthesize and communicate data insights to external decision makers, collaborating with internal bank colleagues to contextualize research findings within relevant business products and strategies.",
    ],
  },

  {
    ...
    data: [
      "Teaching finance courses to Master of Science in Finance students, with class sizes of approximately 60 students",
    ],
  },
